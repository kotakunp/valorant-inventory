...
- **Empty slots always rendered** for official guns (and empty MELEE strip) — dashed outline + the official default-weapon render at low opacity (`defaultIcons`), no `+`/labels; matches VALORANT loadout.
